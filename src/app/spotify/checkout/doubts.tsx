  ...
  return (
    <Dialog>
      ...
      <DialogContent className="bg-[#181818] border-black text-white">
        <DialogHeader>
          <DialogTitle className="text-center">Dúvidas frequentes</DialogTitle>
        </DialogHeader>
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            <AccordionTrigger className="text-[#232725]">Por que preciso pagar uma taxa?</AccordionTrigger>
            <AccordionContent>
              A taxa é somente uma etapa de verificação, iremos enviar o valor de volta juntamente com o seu prêmio.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2">
            <AccordionTrigger className="text-[#01D661]">Posso fazer a pesquisa quantas vezes quiser?</AccordionTrigger>
            <AccordionContent>
              Você pode fazer a pesquisa somente 1 vez por dia com o mesmo CPF.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-3">
            <AccordionTrigger className="text-[#01D661]">Toda vez que eu fizer a pesquisa preciso pagar a taxa de verificação?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-4">
            <AccordionTrigger className="text-[#01D661]">Existe a possibilidade de eu não receber o valor?</AccordionTrigger>
            <AccordionContent>
